---
description: Core project rules for XANH - Design & Build website. Always read this file first.
globs: **/*
---
...
2. **Performance** — PageSpeed > 90, LCP < 2.5s, CLS < 0.1, INP < 200ms
3. **Accessibility** — WCAG 2.1 AA, `prefers-reduced-motion`, keyboard nav
4. **SEO** — Single H1/page, schema JSON-LD, unique title+meta per page
5. **Security** — Nonce + capability checks, sanitize inputs, escape outputs
