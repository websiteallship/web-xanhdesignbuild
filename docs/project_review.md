...
|---|---|---|
| **Headline** | **Inter** (SemiBold/Bold) | Mạnh mẽ, cá tính, sang trọng. Variable font `.ttf` |
| **Body text** | **Inter** (Regular/Medium) | Dễ đọc, hỗ trợ tốt mọi thiết bị. Variable font `.ttf` (Regular + Italic) |

> [!TIP]
> Font Inter đã được cung cấp sẵn trong `docs/FONT/INTER/`. Cần tích hợp `@font-face` vào CSS.
...
| # | Section | Nội dung chính | UI đặc biệt |
|---|---|---|---|
| 1 | **Hero Banner** | *"Câu Chuyện Của Sự Liền Mạch & Bền Vững"* | Ảnh/video nội thất sang trọng. Overlay tối. Font Inter Bold |
...
| Loại | Vị trí | Ghi chú |
|---|---|---|
| Font Inter | `docs/FONT/INTER/` | Variable font TTF (weight 100-900) |
...
- [ ] Cài đặt SSL
- [ ] Tích hợp font Inter via `@font-face`
