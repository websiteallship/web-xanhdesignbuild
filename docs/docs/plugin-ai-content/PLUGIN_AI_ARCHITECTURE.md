...
│   │   ├── history-page.php          [P2]
│   │   ├── topics-page.php           [P2]
│   │   ├── dashboard-page.php         [✅ Analytics dashboard]
...
│
├── [✅]  Xanh_AI_Tracker     → record_usage(), get_range(), estimate_cost(), export_csv(), reset_month()
...
| `xanh_ai_usage_YYYY_MM` | JSON (monthly usage) | — |
