...
| 30 | **Usage Dashboard** | Charts: token usage/month, cost estimate, top Angles, success rate, quality trends | `admin/dashboard.php` |

**Deliverables:**
- [ ] Bài tiếng Anh đúng EN tone, không lẫn tiếng Việt
- [ ] Social snippets phù hợp từng platform
- [ ] Usage dashboard hiển thị chi phí token realtime
...
│   └── dashboard.php               ← Usage Dashboard UI
├── assets/
