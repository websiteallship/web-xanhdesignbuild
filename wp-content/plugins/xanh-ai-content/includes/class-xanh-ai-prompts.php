...
Trả về JSON CHÍNH XÁC theo cấu trúc sau (KHÔNG thêm bất kỳ text nào ngoài JSON):
{
  ...
  "image_prompt": "Prompt mô tả ảnh đại diện bằng tiếng Anh, phong cách editorial photography",
  "section_images": [
    {"after_h2": "Tiêu đề H2 section 1", "prompt": "Editorial photography prompt tiếng Anh mô tả ảnh minh họa phù hợp nội dung section, warm luxury, Nha Trang"},
